...
-- SamsungBrowser, Iron, Safari, Skyfire, Tizen, Webkit, PaleMoon, SailfishBrowser,
-- Gecko, Trident, Presto, Goanna, iOS, Android, Sailfish, BlackBerry, BREW, Java,
-- Windows Phone OS, Windows Phone, Windows CE, Windows NT, Symbian, webOS
-- @param   user_agent  http_header['User-Agent']
